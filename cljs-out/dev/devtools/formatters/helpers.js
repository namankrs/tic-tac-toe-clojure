...
var G__12217 = devtools.prefs.pref.call(null,v);
v = G__12217;
continue;
} else {
return v;
...
}catch (e12220){var _e__11231__auto__ = e12220;
return false;
}})();
...
}catch (e12224){var _e__11231__auto__ = e12224;
return false;
}})();
...
}catch (e12226){var _e__11231__auto__ = e12226;
return false;
}}
}
});
...
var vec__12228 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12228,(0),null);
var name = cljs.core.nth.call(null,vec__12228,(1),null);
...
return cljs.core.some.call(null,(function (p1__12231_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12231_SHARP_);
}),template);
});
